...
#ifndef SNITEMPRIVATE_H
#define SNITEMPRIVATE_H
...
SnItem  *sn_item_new (const char *busname, const char *busobj, int iconsize);
...
#define STATUSNOTIFIERITEM_XML                                                                \
	...
	"  </interface>\n"                                                                    \
	"</node>\n"
#endif /* STATUSNOTIFIERITEM_XML */

G_END_DECLS

#endif /* SNITEMPRIVATE_H */
